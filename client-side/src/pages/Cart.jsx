    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm p-4 flex justify-between items-center">
        <h1 className="text-2xl font-bold text-orange-600 flex items-center gap-4">
          <button onClick={() => navigator('/')} aria-label="Go back">
            <ArrowLeft />
          </button>
          Yumify
        </h1>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center justify-between bg-gray-100 p-1 rounded-full">
                    ...
                    <span className="p-2 text-sm font-bold text-orange-500">
                      Delivery
                    </span>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-orange-600 text-white font-bold py-3 rounded-xl hover:bg-orange-700 transition duration-150 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Proceed to Payment
                </button>
              </div>
