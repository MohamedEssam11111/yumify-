      ...
      .then((res) => {
        ...
        setOrderStatus({
          confirmed:
            ...
            res.data.status === "cooking" ||
            res.data.status === "on the way" ||
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-[#071018] font-poppins">
      <div className="bg-white dark:bg-gray-900 p-6 md:p-10 rounded-2xl shadow-xl dark:shadow-[0_10px_30px_rgba(2,6,23,0.6)] w-full max-w-2xl mx-4">
        ...
        <div className="relative flex justify-between items-start w-full my-10">
          {/* baseline: lighter in light mode, much darker and subtle in dark mode */}
              ...
              >
                ...
                <span
                  className={`mt-3 text-sm font-medium transition-colors duration-500 ${
                    isCompleted || isActive ? "text-gray-800 dark:text-gray-100 font-semibold" : "text-gray-400 dark:text-gray-500"
                  }`}
                >
                  {step.title}
                </span>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-3">
          <button
            onClick={() => {
              toast.error("you can't reach out to this restaurant at the moment...");
            }}
            className="w-full md:w-auto bg-orange-600 text-white font-medium py-3 px-8 rounded-full shadow-lg hover:bg-orange-700 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
          >
